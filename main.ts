...
forever(function () {
    for (let index = 0; index < 4; index++) {
        music.play(music.stringPlayable("C - C E F G B C5 ", 300), music.PlaybackMode.UntilDone)
    }
    for (let index = 0; index < 2; index++) {
        music.play(music.stringPlayable("B A G C5 - C5 - C5 ", 300), music.PlaybackMode.UntilDone)
    }
})
